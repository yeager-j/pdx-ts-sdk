...
`@pdx-ts/stellaris-vanilla` is generated by `tools/vanilla-codegen` from a real
...
the package version *is* the game version, and `buildMod` refuses a mismatched
...
rejoined with `_` *is* the id; `static_modifier` nests by the vanilla file each
