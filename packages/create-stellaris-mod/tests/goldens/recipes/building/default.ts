...
export const resonanceTheory = mod.building("resonance_theory", {
  ...
  // technology is a plain string, checked against the game when
  // @pdx-ts/stellaris-ids is installed; one of your own is the binding another
  // feature file exports, imported as usual.
