...
def parse_save(case, witness):
    ...
    check('4.4.6' in parsed['version'], f'{case.name}/{witness}: Windows build save version')
    return parsed
...
for row in report['cases']:
    ...
    player = ready['player']
    check(player=='0',f'{case.name}: game save matches the supplied fixture human player')
