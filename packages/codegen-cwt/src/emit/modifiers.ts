...
export function emitModifiers(join: ModifierJoin): ModifierEmission {
  ...
  code +=
    ...
    'export type EconomicTriggeredTypes<W extends import("../content/types.ts").EconomicCategoryWitness, F extends EconomicTriggeredField, K extends string> = EconomicTriggeredRows<W, F> extends infer R ? R extends unknown ? K extends EconomicTriggeredRowKey<R> ? R extends { readonly modifierTypes: readonly (infer M)[] } ? M & ("add" | "mult") : never : never : never : never;\n' +
    ...
    'export type EconomicTriggeredKeyGuard<W extends import("../content/types.ts").EconomicCategoryWitness, K> = EconomicTriggeredKeyId<K> extends infer I extends string ? string extends I ? never : [I] extends [EconomicTriggeredKeys<W>] ? IsUnion<EconomicTriggeredCapability<W, I>> extends true ? never : K : never : never;\n' +
