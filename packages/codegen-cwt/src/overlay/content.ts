/**
 * Content-surface overlay: audited departures from a mechanical rules
 * reading that concern content-type fields, localisation, patches, and
 * registry identity — everything `emit/content-type.ts`, the content
 * definers, and the patch emitters read.
 *
