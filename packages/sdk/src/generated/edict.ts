...
export interface EdictFields {
  ...
  /** an effect that is executed when this trigger activates. */
  onDisabled?: EffectBlock<"country">;
}
...
export const EDICT_FIELDS: readonly ContentField[] = [
  ...
  { key: "edict_cap_usage", member: "edictCapUsage", shape: "value", conversion: "identity" },
  { key: "resources", member: "resources", shape: "economicResources", repeated: true },
  { key: "unity_cost_mult", member: "unityCostMult", shape: "value", conversion: "identity" },
  ...
  { key: "on_disabled", member: "onDisabled", shape: "effect" },
];
