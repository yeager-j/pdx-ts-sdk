...
/** `enum[animation_mode]`. */
export type AnimationMode = "overlay" | "add" | "multiply";

/** `enum[animation_type]`. */
export type AnimationType = "scrolling" | "rotating" | "pulsing" | "rotating_ccw" | "rotating_cw";
...
/** `enum[message_variable_type]`. */
export type MessageVariableType = "key" | "name" | "variable";
...
/**
 * `enum[model_animation]`.
 * Its members come from game content, and are narrowed by @pdx-ts/stellaris-ids.
 */
export type ModelAnimation = VanillaEnumMember<"model_animation"> | (string & {});

/**
 * `enum[model_locator]`.
 * Its members come from game content, and are narrowed by @pdx-ts/stellaris-ids.
 */
export type ModelLocator = VanillaEnumMember<"model_locator"> | (string & {});

/**
 * `enum[model_state]`.
 * Its members come from game content, and are narrowed by @pdx-ts/stellaris-ids.
 */
export type ModelState = VanillaEnumMember<"model_state"> | (string & {});
...
export type SpriteType =
  "planet" | "room" | "empty_room" | "character" | "character_large" | "character_without_room";
