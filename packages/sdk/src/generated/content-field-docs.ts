...
import { SPECIMEN_FIELDS } from "./specimen.ts";
import {
...
> = new Map<readonly ContentField[], Readonly<Record<string, ContentMemberDoc>>>([
  ...
  [
    DECISION_FIELDS,
    {
      ...
      resources: {
        ...
        docs: [],
        memberType:
          'WithFrom<EconomicResourceBlock<NoInfer<S>>[], NoInfer<S>, { readonly root: "carrier"; readonly from: "country" }>',
      },
      showTechUnlockIf: { optional: true, docs: [], memberType: 'Trigger<"country">' },
      potential: {
        optional: true,
        docs: [],
        memberType:
          'WithFrom<Trigger<NoInfer<S>>, NoInfer<S>, { readonly root: "carrier"; readonly from: "country" }>',
      },
      allow: {
        optional: true,
        docs: [],
      ...
      abortEffect: {
        ...
        docs: [],
        memberType:
          'EffectBlock<NoInfer<S>, { readonly root: "carrier"; readonly from: "country" }>',
      },
      onQueued: {
        optional: true,
        docs: [],
      ...
      aiWeight: {
        ...
        docs: [],
        memberType:
          'WithFrom<WeightBlock<NoInfer<S>>, NoInfer<S>, { readonly root: "carrier"; readonly from: "country" }>',
      },
      prerequisites: { optional: true, docs: [], memberType: "(TechnologyRef | string)[]" },
    },
  ],
  [
    DECISION_CUSTOM_TOOLTIP_FIELDS,
    {
      ...
      failText: {
        ...
        memberType: '"default" | LocalizationInput',
      },
      successText: {
        optional: true,
        docs: [
  ...
  [
    UTILITY_COMPONENT_TEMPLATE_FIELDS,
    {
      ...
      customTooltip: {
        optional: true,
        docs: [],
        memberType: "LocalizationInput | UtilityComponentTemplateCustomTooltip",
      },
  ...
  [
    WEAPON_COMPONENT_TEMPLATE_FIELDS,
    {
      ...
      customTooltip: {
        optional: true,
        docs: [],
        memberType: "LocalizationInput | WeaponComponentTemplateCustomTooltip",
      },
      shouldAiUse: { optional: true, docs: [], memberType: "boolean" },
      validForCountry: { optional: true, docs: [], memberType: 'Trigger<"country">' },
      aiWeight: { optional: true, docs: [], memberType: 'WeightBlock<"country">' },
  ...
  [
    STRIKE_CRAFT_COMPONENT_TEMPLATE_FIELDS,
    {
      ...
      customTooltip: {
        optional: true,
        docs: [],
        memberType: "LocalizationInput | StrikeCraftComponentTemplateCustomTooltip",
      },
      shouldAiUse: { optional: true, docs: [], memberType: "boolean" },
      validForCountry: { optional: true, docs: [], memberType: 'Trigger<"country">' },
      aiWeight: { optional: true, docs: [], memberType: 'WeightBlock<"country">' },
  ...
  [
    ARCHAEOLOGICAL_SITE_TYPE_FIELDS,
    {
      ...
      conditionalDesc: {
        ...
        memberType: "LocalizationInput | ArchaeologicalSiteTypeDesc[]",
      },
  ...
  [
    MISSION_FIELDS,
    {
      ...
      conditionalDesc: {
        ...
        memberType: "LocalizationInput | MissionDesc[]",
      },
      descOperator: {
        optional: true,
        docs: [
        ...
        memberType: "LocalizationInput | MissionDescOperator[]",
      },
      descIssuer: {
        optional: true,
        docs: [
        ...
        memberType: "LocalizationInput | MissionDescIssuer[]",
      },
      eventChain: {
        optional: true,
        docs: [
      ...
      potentialOperator: {
        ...
        memberType:
          'WithFrom<Trigger<"country">, "country", { readonly root: "country"; readonly from: NoInfer<L>; readonly fromfrom: "country" }>',
      },
      possibleOperator: {
        optional: true,
        docs: [
      ...
      abortTrigger: {
        ...
        memberType:
          'WithFrom<Trigger<"country">, "country", { readonly root: "country"; readonly from: "country"; readonly fromfrom: NoInfer<L>; readonly prev: "country" }>',
      },
      onCancel: {
        optional: true,
        docs: [
      ...
      issuedAbortTrigger: {
        ...
        memberType:
          'WithFrom<Trigger<"country">, "country", { readonly root: "country"; readonly from: "country"; readonly fromfrom: NoInfer<L> }>',
      },
      sound: {
        optional: true,
  ...
  [
    MISSION_CATEGORY_FIELDS,
    {
      isContract: {
        optional: false,
        docs: ["Whether this is a contract category."],
        memberType: "boolean",
      },
  ...
  [
    SITUATION_TYPE_FIELDS,
    {
      ...
      title: { optional: true, docs: [], memberType: "LocalizationInput | SituationTypeTitle[]" },
      conditionalDesc: {
        optional: true,
        docs: [],
        memberType: "LocalizationInput | SituationTypeDesc[]",
      },
      activeTooltip: {
        optional: true,
        docs: [
  ...
  [
    SCRIPTED_LOC_FIELDS,
    {
      ...
      default: {
        ...
        memberType: "LocalizationInput | SpriteRef | LiteralText",
      },
    },
  ],
  [
  ...
  [
    SPECIMEN_FIELDS,
    {
      icon: {
        optional: false,
        docs: ["Sprite shown for the specimen in the Grand Archive."],
        memberType: "SpriteRef | string",
      },
      type: {
        optional: false,
        docs: ["Grand Archive collection that contains the specimen."],
        memberType: "SpecimenType",
        literals: ["aesthetic_wonder", "historical_item", "xeno_geology"],
      },
      rarity: {
        optional: false,
        docs: ["Rarity tier used for the specimen's display and upkeep."],
        memberType: "SpecimensRarity",
        literals: ["common", "rare", "epic", "exceptional"],
      },
      isTradable: {
        optional: true,
        docs: ["Whether other empires can trade the specimen. Defaults to yes when omitted."],
        memberType: "boolean",
      },
      isSellable: {
        optional: true,
        docs: ["Whether the specimen can be sold. Defaults to yes when omitted."],
        memberType: "boolean",
      },
      resources: {
        optional: true,
        docs: ["Resources produced or consumed while the specimen is exhibited."],
        memberType: "EconomicResourceBlock<ScopeName>[]",
      },
      triggeredCountryModifier: {
        optional: true,
  ...
  [
    MEGASTRUCTURE_FIELDS,
    {
      ...
      upgradeDesc: {
        ...
        memberType: 'LocalizationInput | "hide"',
      },
  ...
  [
    GOVERNMENT_TRIGGER_FIELDS,
    {
      text: { optional: true, docs: [], memberType: "LocalizationInput" },
  ...
  [
    PLANET_INITIALIZER_FIELDS,
    {
      name: { optional: true, docs: [], memberType: "LocalizationInput" },
