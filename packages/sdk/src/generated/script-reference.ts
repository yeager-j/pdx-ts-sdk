...
export const SCRIPT_EFFECT_REFERENCES = [
  ...
  },
  {
    ...
    availability: { kind: "universal" },
    signature:
      "createMessage(args: { type: MessageTypeRef | string; localization?: string; customMessageText?: string; days?: number; customToastIcon?: SpriteRef | string; target?: ScopeValue; recipient?: ScopeValue; variable?: readonly { varname?: ScriptValue; type?: MesageVariableType; key?: string; value?: string; localization?: string; scope?: ScopeValue; trigger?: Trigger<ScopeName> }[] }): void;",
    docs: [
