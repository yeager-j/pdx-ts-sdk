...
export const CIVIC_OR_ORIGIN_SWAP_TYPE_FIELDS: readonly ContentField[] = [
  ...
  { key: "hide_modifiers", member: "hideModifiers", shape: "value", conversion: "identity" },
];
...
export const CIVIC_OR_ORIGIN_MODIFICATION_FIELDS: readonly ContentField[] = [
  ...
  { key: "add", member: "add", shape: "trigger" },
  { key: "remove", member: "remove", shape: "trigger" },
];
...
export const CIVIC_OR_ORIGIN_FIELDS: readonly ContentField[] = [
  ...
  { key: "ai_playable", member: "aiPlayable", shape: "trigger" },
  { key: "flags", member: "flags", shape: "valueList", conversion: "identity" },
  { key: "potential", member: "potential", shape: "aliasStruct", category: "government_trigger" },
  ...
  { key: "pickable_at_start", member: "pickableAtStart", shape: "value", conversion: "identity" },
  {
    key: "modification",
    member: "modification",
    shape: "dual",
  ...
  { key: "traits", member: "traits", shape: "struct", fields: CIVIC_OR_ORIGIN_TRAITS_FIELDS },
  {
  ...
  { key: "room", member: "room", shape: "value", conversion: "ref" },
  {
