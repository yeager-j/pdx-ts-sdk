...
export const WAR_GOAL_FIELDS: readonly ContentField[] = [
  ...
  { key: "defender_default", member: "defenderDefault", shape: "value", conversion: "identity" },
  { key: "threat_multiplier", member: "threatMultiplier", shape: "value", conversion: "identity" },
  {
  ...
  { key: "total_war", member: "totalWar", shape: "value", conversion: "identity" },
  { key: "hide_if_no_cb", member: "hideIfNoCb", shape: "value", conversion: "identity" },
  {
  ...
  { key: "on_status_quo", member: "onStatusQuo", shape: "effect" },
  { key: "on_wargoal_set", member: "onWargoalSet", shape: "effect" },
  { key: "on_accept", member: "onAccept", shape: "effect" },
  ...
  { key: "destroy_starbases", member: "destroyStarbases", shape: "value", conversion: "identity" },
  {
