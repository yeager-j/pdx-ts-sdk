 ...
 * receive from the `location` passed to `enable_mission`. The generated
 * mission item retains that declaration, and this overload requires a
 * matching location whenever the declaration is present.
 */

import type { EnableMissionArgs } from "../../generated/effects.ts";
