...
export const OBSERVATIONS: readonly ClassifiedObservation[] = [
  ...
  },
  {
    ...
    classification: "rules-wider-than-vanilla",
    declaration: MODIFIER_ROW,
    rationale: weightRows("holder at common/strategic_resources.cwt:91"),
  },
  {
    registry: "resource",
    ...
    classification: "rules-wider-than-vanilla",
    declaration: MODIFIER_ROW,
    rationale: weightRows("holder at common/strategic_resources.cwt:83"),
  },
  {
    registry: "resource",
    field: "dynamic_capacity.modifier",
    kind: "arity",
    evidence: [],
    classification: "rules-wider-than-vanilla",
    declaration: MODIFIER_ROW,
    rationale: weightRows("holder at common/strategic_resources.cwt:53"),
  },
  {
