  ...
  const systems: readonly (readonly [string, Omit<SolarSystemInitializerDef, "id">])[] = [
    ...
    [
      "overlap_showcase",
      {
        class: "sc_g",
        planet: [
          { class: "star", size: 40, orbitDistance: 0, orbitAngle: 0 },
          {
            class: "pc_continental",
            size: 25,
            orbitDistance: 12,
            orbitAngle: 0,
            moon: [{ class: "pc_barren", size: 4, orbitDistance: 4, orbitAngle: 0 }],
          },
          { class: "pc_barren", size: 25, orbitDistance: 3, orbitAngle: 5 },
          {
            class: "pc_desert",
            size: 16,
            count: 3,
            orbitDistance: { min: -3, max: 3 },
            orbitAngle: 0,
          },
        ],
      },
