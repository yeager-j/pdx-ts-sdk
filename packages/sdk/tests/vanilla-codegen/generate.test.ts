...
import { fileBucketKey } from "../../../../tools/vanilla-codegen/trie.ts";
...
describe("trie", () => {
  ...
  it("buckets a file-buckets registry by its vanilla source files", () => {
    ...
    expect(file("registries/static-modifier/index.ts")).toMatchInlineSnapshot(`
      ...
      import type { VanillaStaticModifierTrieDeficit } from "./d.ts";
      import type { VanillaStaticModifierTrieParagon } from "./p.ts";
  ...
  it("spells a file bucket's leaves with the whole id, never a path join", () => {
    // The load-bearing difference from the segment trie: `deficit` is a
    // filename and no part of any id.
    expect(file("registries/static-modifier/p.ts")).toMatchInlineSnapshot(`
      "// Generated by tools/vanilla-codegen from Stellaris 4.4.6. Do not edit.
