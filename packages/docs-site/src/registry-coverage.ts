...
export const UNDOCUMENTED_REGISTRIES: Readonly<Record<string, string>> = {
  ...
  section_template: "SDK-208 — the ship stack",
  component_set: "SDK-208 — the ship stack",
  utility_component_template: "SDK-208 — the ship stack",
  weapon_component_template: "SDK-208 — the ship stack",
  strike_craft_component_template: "SDK-208 — the ship stack",
