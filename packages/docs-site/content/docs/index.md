...
`@pdx-ts/sdk` builds Stellaris mods from TypeScript. You write ordinary TypeScript; the build
turns your triggers, effects, and content definitions into PDXScript and writes a mod the
...
the ones with no reference page yet.
