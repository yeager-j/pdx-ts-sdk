...
| -------------------------- | ----------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| `@pdx-ts/sdk`              | The pipeline a build script calls                                             | `createModProject`, `createMod`, `discoverFeatures`, `render`, `write`, `install`, `runBuild`, `runInspect`, `runInstall`, the error classes    |
