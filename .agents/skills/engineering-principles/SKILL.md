...
description: Use this skill when designing, reviewing, or writing code to apply a consistent set of engineering principles covering authority/ownership of state, module boundaries, interface design, testing rigor, and proportionate use of mechanism. It provides guidance for judging where a fact or decision should live, when to add abstraction versus resist it, and how to verify changes—useful both for making design decisions and for critiquing existing code.
---
